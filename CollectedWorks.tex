...
\newfontface\textsbit{EB Garamond SemiBoldItalic}

\setmathfont{Garamond-Math.otf}[StylisticSet=4]
...
\newcommand{\truncatedtext}{}
\newcommand{\updatetruncatedtext}{%
  \renewcommand{\truncatedtext}{\sffamily\smallcaps{\MakeTextUppercase{\leftmark}}}%
}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[RO]{\updatetruncatedtext%
  \sbox1{{\sffamily\Large\textbar~\allcapsspacing{ARTICLE}}}%
  \newdimen\titlewidth%
  \titlewidth=\dimexpr\linewidth-\wd1-0.5em\relax%
  \makebox[\linewidth][r]{\truncateheader{\truncatedtext}{\titlewidth}~{\sffamily\Large\textbar~\allcapsspacing{ARTICLE}}}}
\fancyhead[LE]{\updatetruncatedtext%
  \sbox1{{\sffamily\Large\allcapsspacing{ARTICLE}~\textbar}}%
  \newdimen\titlewidth%
  \titlewidth=\dimexpr\linewidth-\wd1-0.5em\relax%
  \makebox[\linewidth][l]{{\sffamily\Large\allcapsspacing{ARTICLE}~\textbar}~\truncateheader{\truncatedtext}{\titlewidth}}}
